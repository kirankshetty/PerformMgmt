...
const navItems: NavItem[] = [
  ...
  { href: "/functional-areas-hr", label: "Functional Areas", icon: Layers, roles: ["hr_manager"] },
  ...
  { href: "/kra-goals", label: "KRA / Goals", icon: Target, roles: ["hr_manager"] },
  ...
  { href: "/set-targets", label: "Set Targets for KRA/Goal", icon: Target, roles: ["manager", "employee"] },
